    ...
    <div class="login-box">
      <div class="login-box-body">
        ...
        <p class="login-box-msg"><center><b><h2>Metode Biseksi</h2> </b></center></p>
          <p>Carilah akar persamaan dari <strong>f(x) = e<sup>x</sup>- x - 2</strong></p>
     ...
     <td>&nbsp;</td>
     <td>
         <input class="btn btn-success btn-block btn-flat" type="submit" name="button" id="button" value="Proses" />
         &nbsp;
		 <a href="<?php echo $_SERVER['PHP_SELF']; ?>">
			<input class="btn btn-warning btn-block btn-flat" type="button" name="button" id="button" value="Hapus" />
         </a>
     </td>
     </tr>
     </table>
